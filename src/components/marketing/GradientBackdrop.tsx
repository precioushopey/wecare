...
export function GradientBackdrop() {
  return (
    ...
    >
      <div className="orb-drift-a absolute -right-1/4 -top-1/4 size-[60vw] rounded-full bg-sky-300/60 blur-[90px] lg:-right-40 lg:-top-48 lg:size-[42rem] lg:blur-[130px]" />
      <div className="orb-drift-b absolute -left-1/4 top-1/3 size-[55vw] rounded-full bg-sky-400/40 blur-[100px] lg:-left-52 lg:size-[36rem] lg:blur-[140px]" />
      <div className="orb-drift-c absolute -bottom-1/4 -right-[12%] size-[60vw] rounded-full bg-sky-200/55 blur-[100px] lg:-bottom-56 lg:right-1/4 lg:size-[38rem] lg:blur-[150px]" />
    </div>
  );
}
