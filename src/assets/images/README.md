...
| File | Used on |
|------|---------|
| `Condition Page.png` | homepage hero (doctor photo) |
| `How it works Page.png` | homepage final-CTA image (in-grid, bottom-faded) |
| `Homepage/Hero.png` | homepage "How WeCare works" section anchor; General Wellness fallback hero |
| `Homepage/8.png` | homepage "A guided and responsible experience" section anchor |
| `Homepage/9–12.png` | "Choose your concern" card banners (sleep / pain / stress / migraine) |
| `Knowledge Hub/Hero.png` | homepage "Simple recommendations" section anchor |
...
- `Knowledge Hub/59–66.png` — the Knowledge Hub page is still a stub.
